...
public class ElasticUtil {
     ...
     */
    public static void builderSortPageable(List<OrderByBuilder> sort, String defaultField, List<Object> searchAfter,
                                           Integer count, NativeSearchQueryBuilder queryBuilder) {
        // 游标不为空时，加入游标查询
        ...
        // 排序不为空时，加入排序
        builderSort(sort, defaultField, queryBuilder);
     ...
     * @param queryBuilder 查询构建器
     */
    public static void builderSort(List<OrderByBuilder> sort, String defaultField, NativeSearchQueryBuilder queryBuilder) {
